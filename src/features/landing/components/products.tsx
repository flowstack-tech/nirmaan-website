...
import { ReactComponent as AddIcon } from "@features/landing/assets/add-icon.svg";
...
import BricksBlocks from "../assets/bricks-blocks.jpg";
import Cement from "../assets/cement.jpg";
import Chemicals from "../assets/chemicals.jpg";
import Concrete from "../assets/concrete.jpg";
import Floorings from "../assets/floorings.jpg";
import Paint from "../assets/paint.jpg";
import SandAggregate from "../assets/sand-aggregate.jpg";
  ...
  return (
    <Paper className={classes.root} elevation={0}>
        ...
        {successful ? (
          ...
          <Container maxWidth="lg" className={classes.form}>
            ...
            <Box
              ...
              color="rgba(167, 183, 208, 1)"
              pt={2}>
              For further assistance, please contact us at +91-8017944104 or email us at contactus@nirmaanhaat.com
            </Box>
          </Container>
        )}
      </Dialog>
      <Container maxWidth="lg">
        ...
        <Grid container spacing={matches ? 4 : 6}>
          <Grid item md={3} xs={6} className={classes.gridItemContainer} onClick={() => openForm("Bricks and Blocks")}>
            <img src={BricksBlocks} alt="Bricks and Blocks" className={classes.productImages} />
            <Box
          ...
          <Grid item md={3} xs={6} className={classes.gridItemContainer} onClick={() => openForm("Concrete")}>
            <img src={Concrete} alt="Concrete" className={classes.productImages} />
            <Box
              fontSize={matches ? "h6.fontSize" : "h5.fontSize"}
              fontWeight={400}
              fontFamily="Work Sans"
          ...
          <Grid item md={3} xs={6} className={classes.gridItemContainer} onClick={() => openForm("Chemicals")}>
            <img src={Chemicals} alt="Chemicals" className={classes.productImages} />
            <Box
              fontSize={matches ? "h6.fontSize" : "h5.fontSize"}
              fontWeight={400}
              fontFamily="Work Sans"
          ...
          <Grid item md={3} xs={6} className={classes.gridItemContainer} onClick={() => openForm("Floorings")}>
            <img src={Floorings} alt="Floorings" className={classes.productImages} />
            <Box
              fontSize={matches ? "h6.fontSize" : "h5.fontSize"}
              fontWeight={400}
              fontFamily="Work Sans"
          ...
          <Grid item md={3} xs={6} className={classes.gridItemContainer} onClick={() => openForm("Sand and Aggregate")}>
            <img src={SandAggregate} alt="Sand and Aggregate" className={classes.productImages} />
            <Box
              fontSize={matches ? "h6.fontSize" : "h5.fontSize"}
              fontWeight={400}
              fontFamily="Work Sans"
          ...
          <Grid item md={3} xs={6} className={classes.gridItemContainer} onClick={() => openForm("Paint")}>
            <img src={Paint} alt="Paint" className={classes.productImages} />
            <Box
              fontSize={matches ? "h6.fontSize" : "h5.fontSize"}
              fontWeight={400}
              fontFamily="Work Sans"
          ...
          <Grid item md={3} xs={6} className={classes.gridItemContainer} onClick={() => openForm("Cement")}>
            <img src={Cement} alt="Cement" className={classes.productImages} />
            <Box
              fontSize={matches ? "h6.fontSize" : "h5.fontSize"}
              fontWeight={400}
              fontFamily="Work Sans"
          ...
          <Grid item md={3} xs={6} className={classes.gridItemContainer} onClick={() => openForm("Steel")}>
            <img src={Steel} alt="Steel" className={classes.productImages} />
            <Box
              fontSize={matches ? "h6.fontSize" : "h5.fontSize"}
              fontWeight={400}
              fontFamily="Work Sans"
