...
import { ReactComponent as SupplierImage } from "../assets/supplier.svg";
import { ReactComponent as SupplierPaymentsIcon } from "../assets/supplier-payments.svg";
import { ReactComponent as SupplierSalesIcon } from "../assets/supplier-sales.svg";
import { ReactComponent as SupplierImageSmall } from "../assets/supplier-small.svg";
import { ReactComponent as SupplierUtilizationIcon } from "../assets/supplier-utilization.svg";
...
const Supplier: React.FC = () => {
  ...
  }, [firstname, products, name, email, contact, address, pin]);
      ...
      <Container maxWidth="lg">
        <Box display="flex" flexDirection="row-reverse" justifyContent="space-between" alignItems="center">
          <Box ml={8} className={classes.imageContainer}>
            <SupplierImage className={classes.image} />
            <SupplierImageSmall className={classes.imageSmall} />
          </Box>
          <Box display="flex" flexDirection="column">
            <Box
              ...
              color="rgba(22, 54, 102, 1)"
              mb={5}>
              Become a supplier with NIRMAAN
            </Box>
            <Box
              ...
              mb={10}>
              Become a certified supplier to realize the full potential of your manufacturing unit
            </Box>
            <Box
              display="flex"
              flexDirection="row"
